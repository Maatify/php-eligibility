...
final class CanonicalAcceptanceEvidenceMap
{
    ...
    public static function scenarios(): array
    {
        return [
            ...
            self::scenario(7, 'A matching DENY-only value denies.', RuntimeEvaluationServiceTest::class, 'denyMatchWinsAndTraceContainsEveryMatchingEffect', 'unit'),
            ...
            self::scenario(13, 'One matching value among multiple Context values satisfies ALLOW.', RuntimeEvaluationServiceTest::class, 'allowMatchPassesAndReturnsMatchingAllowTrace', 'unit'),
            ...
            self::scenario(16, 'All ruled dimensions combine with AND when they pass.', RuntimeEvaluationServiceTest::class, 'dimensionsUseAndSemanticsAndAllOutcomesRemainVisibleAfterFailure', 'unit'),
            ...
            self::scenario(40, 'Batch evaluation uses bounded bulk loading rather than per-Subject reads.', RuntimeEvaluationServiceTest::class, 'batchIsOrderedEquivalentToSingleAndUsesOneBulkRead', 'unit'),
            self::scenario(41, 'Replacement reuses, updates, reactivates, creates, and deactivates atomically.', EligibilityRuntimeIntegrationTest::class, 'realReplacementReactivatesExistingRulesAndEmptyReplacementDeactivatesWithoutDeleting', 'integration'),
            ...
            self::scenario(46, 'Public collections use canonical ordering independent of DB row order.', PdoRuleRepositoryIntegrationTest::class, 'criteriaReturnsBothLifecyclesWithFiltersAndCanonicalOrdering', 'integration'),
